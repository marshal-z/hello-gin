...
func EditArticle(c *gin.Context) {
	...
	valid.MaxSize(description, 255, "description").Message("Briefly description as a maximum of 255 character")
	...
	valid.MaxSize(modifiedBy, 100, "modified_by").Message("The modifier is up to 100 character")
